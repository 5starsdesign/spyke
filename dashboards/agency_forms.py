...
class AgencyListingForm(forms.ModelForm):
    ...
    class Meta:
        model = MarketListing
        fields = (
            "listing_kind","title","available_from",
            "address","postcode","city","province",
            "property_type","build_year","living_area","lot_area",
            "rooms","bedrooms","bathrooms","floors","energy_label",
            "garden","balcony","terrace","roof_terrace",
            "storage","shed","parking_garage","parking_spot",
            "elevator","wheelchair_accessible","new_build",
            "solar_panels","heat_pump","smoking_allowed","pets_allowed",
            "suitable_for","price","service_costs","deposit","description",
        )
        labels = {  # NL labels
            "listing_kind":"Aanbodtype","title":"Titel","available_from":"Beschikbaar per",
            "address":"Adres","postcode":"Postcode","city":"Plaats","province":"Provincie",
            "property_type":"Type woning","build_year":"Bouwjaar","living_area":"Woonoppervlakte (m²)","lot_area":"Perceeloppervlakte (m²)",
            "rooms":"Aantal kamers","bedrooms":"Aantal slaapkamers","bathrooms":"Aantal badkamers","floors":"Aantal verdiepingen",
            ...
            "suitable_for":"Geschikt voor","price":"Prijs (€)","service_costs":"Servicekosten p/m","deposit":"Waarborgsom (€)",
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["listing_kind"].widget = RadioSelect(choices=(("HUUR","Huur"),("KOOP","Koop")))
        ...
        if self.is_bound:
            for fname in self.errors:
                try: self.fields[fname].widget.attrs["class"] += " is-invalid"
