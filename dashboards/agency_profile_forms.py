...
class AgencyProfileForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "extra_branches": forms.Textarea(attrs={"class":"form-control","rows":3,"placeholder":"Adres | Tel | Openingstijden"}),
            "lead_contacts": forms.Textarea(attrs={"class":"form-control","rows":3,"placeholder":"Naam | Rol | E-mail | Tel"}),

            "brand_primary_color": forms.TextInput(attrs={"class":"form-control","placeholder":"#0d6efd"}),
            "brand_secondary_color": forms.TextInput(attrs={"class":"form-control","placeholder":"#6c757d"}),
            "brand_accent_color": forms.TextInput(attrs={"class":"form-control","placeholder":"#198754"}),
        ...
        labels = {"published": "Publiek zichtbaar", "logo":"Logo", "cover":"Omslagafbeelding"}
