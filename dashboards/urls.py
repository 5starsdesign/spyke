...
from . import agency_views, member_views, owner_views
...
urlpatterns = [
    ...
    path(
        "member/eigen/overzicht/", member_views.member_own_view, name="member_own_view"
    ),
    path(
        "member/eigen/",
        RedirectView.as_view(pattern_name="member_own_view", permanent=False),
    ),
    # Wens
    path("member/wens/", member_views.member_wish, name="member_wish"),
    path(
        "member/wens/overzicht/", member_views.member_wish_view, name="member_wish_view"
    ),
    # Matches
    ...
    path(
        "owner/<slug:slug>/bewerken/",
        owner_views.owner_listing_edit,
        name="owner_listing_edit",
    ),
    path("owner/profiel/", owner_views.owner_profile, name="owner_profile"),
    path(
        "owner/woning/", RedirectView.as_view(pattern_name="owner_my", permanent=False)
    ),
    # --- AGENCY ---
    ...
    path(
        "agency/<slug:slug>/bewerken/",
        agency_views.agency_listing_edit,
        name="agency_listing_edit",
    ),
    path("agency/profiel/", agency_views.agency_profile, name="agency_profile"),
    path(
        "agency/woning/",
        RedirectView.as_view(pattern_name="agency_home_mijn", permanent=False),
    ),
]
