...
from properties.models import (PROPERTY_TYPES, ExchangeOffer,
                               ExchangeOfferImage, Wish)
...
class MemberOwnForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "my_title": forms.TextInput(
                attrs={
                    "class": "form-control",
                    "placeholder": "Bijv. Ruim 3-kamer appartement",
                }
            ),
            "my_address": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Straat + huisnummer"}
            ),
            "my_postcode": forms.TextInput(
            ...
            "my_parking_garage": forms.CheckboxInput(
    ...
    class Meta:
        ...
        widgets = {
            "city": forms.TextInput(
                attrs={
                    "class": "form-control",
                    "placeholder": "Bijv. Amsterdam, Utrecht / Randstad",
                }
            ),
            "type": forms.Select(
                choices=PROPERTY_TYPES, attrs={"class": "form-select"}
            ),
            ...
            "want_near_schools": forms.CheckboxInput(
                attrs={"class": "form-check-input"}
            ),
            "want_near_ov": forms.CheckboxInput(attrs={"class": "form-check-input"}),
            "want_ground_floor": forms.CheckboxInput(
                attrs={"class": "form-check-input"}
            ),
            ...
            "want_pets_allowed": forms.CheckboxInput(
                attrs={"class": "form-check-input"}
            ),
            "features": forms.Textarea(
                attrs={
                    "class": "form-control",
                    "rows": 3,
                    "placeholder": "Eventuele extra wensen…",
                }
            ),
        }
