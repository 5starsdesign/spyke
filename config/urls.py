...
urlpatterns = [
    ...
    path(
        "makelaars/<slug:slug>/",
        agency_public.agency_public_profile,
        name="agency_public_profile",
    ),
    ...
    path(
        "ruilwoningen/", include("properties.urls"), name="ruil_list_public"
    ),  # pages/props regelen intern
...
urlpatterns.append(
    path(
        "admin/login-as/<int:user_id>/",
        admin_login_as_patch.login_as_view,
        name="admin_login_as",
    )
)
